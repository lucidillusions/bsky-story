 ...
 */
export declare function getPostText(record: unknown, fallback?: string): string;
/**
 * Safely sort thread posts by like count
 */
export declare function sortThreadPostsByLikes(a: unknown, b: unknown): number;
/**
 * Type guard that checks if a post record has text and returns the record properly typed
 */
export declare function isPostWithText(record: unknown): record is AppBskyFeedPost.Record;
